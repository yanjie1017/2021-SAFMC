...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/safmc/catkin_ws/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/safmc/catkin_ws/devel/.private/cv_bridge)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/safmc/catkin_ws/install)
...
if(NOT "/home/safmc/catkin_ws/src/vision_opencv/cv_bridge/include;/usr/include/opencv4 " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/safmc/catkin_ws/src/vision_opencv/cv_bridge/include;/usr/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/safmc/catkin_ws/src/vision_opencv/cv_bridge/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/safmc/catkin_ws/devel/.private/cv_bridge/lib;/home/safmc/catkin_ws/devel/lib;/opt/ros/melodic/lib)
