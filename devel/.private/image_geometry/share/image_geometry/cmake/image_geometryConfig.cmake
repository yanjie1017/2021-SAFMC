...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/safmc/catkin_ws/src/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/safmc/catkin_ws/devel/.private/image_geometry)
  ...
  set(image_geometry_INSTALL_PREFIX /home/safmc/catkin_ws/install)
...
if(NOT "/home/safmc/catkin_ws/src/vision_opencv/image_geometry/include;/usr/include/opencv4 " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/safmc/catkin_ws/src/vision_opencv/image_geometry/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/safmc/catkin_ws/src/vision_opencv/image_geometry/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/safmc/catkin_ws/devel/.private/image_geometry/lib;/home/safmc/catkin_ws/devel/lib;/opt/ros/melodic/lib)
